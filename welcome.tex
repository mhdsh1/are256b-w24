...
\item creating and exporting plots 
(\href{https://www.stata.com/support/faqs/graphics/gph/stata-graphs/}{link})
\item creating regression tables using estout
(\href{https://repec.sowi.unibe.ch/stata/estout/index.html}{link})
